...
graph = helper.make_graph(
    [  # nodes
        ...
        helper.make_node("Mul", ["mul_out", "add1_out"], ["D"], "mul1"),

        # MatMul node after Gelu for recompute
        helper.make_node("MatMul", ["D", "A"], ["E"], "matmul"),
    ],
    ...
    [  # inputs
        ...
        helper.make_tensor_value_info('C', TensorProto.FLOAT, ['unk_1', 'unk_2', 3072]),
    ],
    [  # outputs
        helper.make_tensor_value_info('E', TensorProto.FLOAT, ['unk_3', 'unk_4', 'unk_5']),
    ],
    [  # initializers
